...
#python em_nobrute.py --indir /data/soumen/ncc/glove300 --phrases /data/srijayd/local_data/f_r1_r2_th/th/fh1.csv --model /data/srijayd/models/emmodel/ --train True
...
'''
	...
	for xiter in xrange(maxIters):
		...
		#ranges = [10,4000,1]
		res = optimize.basinhopping(self.f,[3800.])
		k=res.x
		print "X is "	
		print k
