...
#python em_test.py --indir /data/soumen/ncc/glove300 --phrases /data/srijayd/local_data/f_r1_r2_th/th/fh1.csv --model /data/srijayd/models/emmodel/ --train True --alltest True
...
'''
	...
	print "Model path is ",tfModelDirPath
        ...
        tfModelPath = os.path.join(tfModelDirPath, 'compmodel100.tf')
	...
	for xiter in xrange(maxIters):
		for miter in xrange(2):		
			_,dlabel = sess1.run([self.trainopm,tf.transpose(self.labelm)],
						       ...
						       self.labelm: sess1.run(prev_labl)	
                                                       })
			#print "Here"
			#print dlabel
		...
		#ranges = [10,4000,1]
		#k = bisect(self.f,0.001,4000)
		k=scipy.optimize.brentq(self.f,0.001,4000)
		print "X is "	
		print k
