...
#python em_2sess.py --indir /data/soumen/ncc/glove300 --phrases /data/srijayd/local_data/f_r1_r2_th/th/em_test.csv --model /data/srijayd/models/emmodel/ --train True --alltest True 
