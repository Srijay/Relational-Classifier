...
#python em_mtp.py --indir /data/soumen/ncc/glove300 --phrases /data/srijayd/local_data/f_r1_r2_th/th/fh1.csv --model /data/srijayd/models/emmodel/ --train True --alltest True
...
class NccDiscrepancy(NonComp):
	...
	self.k=150  #number of instances with farahmand score >= 0.5
    ...
    def doTrain(self, sess1, sess2, maxIters=10):
	...
	for xiter in xrange(maxIters):
		...
		k = scipy.optimize.brentq(self.f,-40.0,40.0)
		print "X is "	
		print k
