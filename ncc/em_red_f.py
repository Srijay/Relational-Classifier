...
#python em_red_f.py --indir /data/soumen/ncc/glove300 --phrases /data/srijayd/local_data/f_r1_r2_th/reddy.csv --model /data/srijayd/models/emmodel/ --train True
...
'''
	...
	for xiter in xrange(maxIters):
		...
		#print obj
	for yo in idex_nc:
		print allerrs[yo],' ',self.vocabArray[self.allw12[yo]].word,' ',self.ally[yo] 
